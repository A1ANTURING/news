...
<div class="data_list backMain">
	...
	<div class="data_content">
		<form action="${pageContext.request.contextPath }/admin/link/edit" method="post" onsubmit="return checkForm()">
			<table cellpadding="5">
				<tr>
					<td>
						<label>链接名称：</label>
				...
				<tr>
					...
					<td>
						<input type="text" id="linkEmail" name="linkEmail" value="${link.email }"/>
					</td>
				</tr>
				<tr>
					<td>
