...
<div class="data_list backMain">
	...
	<div class="data_content">
		<form action="${pageContext.request.contextPath }/admin/newsType/edit.action" method="post" onsubmit="return checkForm()">
			<table cellpadding="5">
				<tr>
					<td>
						<label>新闻类别名称：</label>
					...
					<td>
						<input type="text" id="newsTypeName" name="newsTypeName" value="${newsType.typename }"/>
					</td>
				</tr>
				<tr>
					<td>
